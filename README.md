...
- [karpathy/autoresearch](https://github.com/karpathy/autoresearch) — Minimal single-GPU setup for AI agents to autonomously run ML experiments. ~630 lines of Python.
- [SakanaAI/AI-Scientist](https://github.com/SakanaAI/AI-Scientist) — End-to-end automated scientific discovery: idea → experiment → paper → peer review.
- [SakanaAI/AI-Scientist-v2](https://github.com/SakanaAI/AI-Scientist-v2) — Template-free agentic tree search; first AI-generated paper to pass peer review.
